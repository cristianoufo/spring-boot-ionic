...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Cristiano Tiago", "cristianotiago@outlook.com", "12527069847", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("9999-9999", "7777-7777"));
        
        Endereco e1 = new Endereco(null, "Rua Arthur K Clarke", "777", "COMPLEMENTO", "Itaquera", "00000-000", cli1, c1);
        Endereco e2 = new Endereco(null, "Rua Jimmi Hendrix", "7777", "COMPLEMENTO", "Itaquera", "00000-000", cli1, c2);
        
        cli1.getEnderecos().addAll(Arrays.asList(e1, e2));
        
        Cliente cli2 = new Cliente(null, "Chris Tiago", "cristiano_ufo@hotmail.com", "12527069847", TipoCliente.PESSOAJURIDICA, pe.encode("123"));
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("7777-7777", "8888-8888"));
        
        Endereco e3 = new Endereco(null, "Rua Arthur K Clarke", "777-A", "COMPLEMENTO", "Itaquera", "00000-000", cli2, c2);
        Endereco e4 = new Endereco(null, "Rua Arthur K Clarke", "777-B", "COMPLEMENTO", "Itaquera", "00000-000", cli2, c2);
